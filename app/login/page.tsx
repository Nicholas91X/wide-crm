    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a]">
      <div className="w-full max-w-sm space-y-8 px-6">
        ...
        <div className="text-center">
          <h1 className="text-5xl font-bold tracking-widest text-[#c9a96e]">WIDE</h1>
          <p className="text-[#888] text-sm tracking-widest mt-1 uppercase">CRM Platform</p>
        </div>

        {/* Card */}
        <div className="bg-[#141414] border border-[#1f1f1f] rounded-xl p-8 space-y-6">
          <div>
            <h2 className="text-xl font-semibold text-[#f5f5f5]">Accedi</h2>
            <p className="text-[#888] text-sm mt-1">Usa il tuo account Google autorizzato</p>
          </div>
